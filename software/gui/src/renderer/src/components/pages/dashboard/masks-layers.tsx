...
function Layers({ setActiveLayer }: LayersProps): React.JSX.Element {
    return (
        <>
            <button
                className="w-5 h-5 border border-[#272729] opacity-90 cursor-pointer z-[3] rounded-lg bg-[#d83939]"
                onClick={() => setActiveLayer(2)}
                aria-label="Red layer"
            ></button>
            <button
                className="w-5 h-5 border border-[#272729] opacity-90 cursor-pointer z-[3] rounded-lg bg-[#3983d8]"
                onClick={() => setActiveLayer(1)}
                aria-label="Blue layer"
            ></button>
            <button
                className="w-5 h-5 border border-[#272729] opacity-90 cursor-pointer z-[3] rounded-lg bg-white relative"
